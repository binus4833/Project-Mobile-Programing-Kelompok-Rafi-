...
public class SSDAdapter extends BaseAdapter {

    private Context mContext;
    private List<ProductSSD> Product;

    public SSDAdapter(Context mContext, List<ProductSSD> Product) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View v = View.inflate(mContext, R.layout.row_ssd, null);
